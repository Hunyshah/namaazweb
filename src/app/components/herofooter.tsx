...
const imageList = [
  { id: "e1", image: "/images/slider1.jpeg" },
  {
    id: "e2",
    ...
    <div className="main-parent flex justify-between bg-slate-950 text-white mt-10 ">
      <div className="flex flex-col items-center">
        <div style={{marginLeft:50}}>
          ...
          <div className=" mt-10">
            <p className="text-4xl font-serif">Please turn off or put your cell phone on silent</p>
          </div>
        </div>
      </div>

      <div style={{ marginBottom: 10, marginRight: 50 }}>
